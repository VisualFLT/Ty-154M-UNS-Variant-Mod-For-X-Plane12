...
simDR_front_lamp_test = find_dataref("sim/custom/buttons/lamp_test_front")
...
simDR_toelev_ratio = find_dataref("sim/custom/controls/control_force_pos")
simDR_torud_ratio = find_dataref("sim/custom/controls/control_force_pos_rud")
...
simDR_stab_work =  find_dataref("sim/custom/lights/stab_work")
simDR_slats_extended =  find_dataref("sim/custom/lights/slats_extended")
simDR_to_rudder =  find_dataref("sim/custom/lights/to_rudder")
simDR_to_elevator =  find_dataref("sim/custom/lights/to_elevator")
