...
defineProperty("anim_rud1_ENG", globalPropertyf("sim/custom/controlls/throttle_1_ENG")) -- РУД 1 БИ
defineProperty("anim_rud2_ENG", globalPropertyf("sim/custom/controlls/throttle_2_ENG")) -- РУД 2 БИ
defineProperty("anim_rud3_ENG", globalPropertyf("sim/custom/controlls/throttle_3_ENG")) -- РУД 3 БИ

defineProperty("revers_L", globalPropertyf("sim/custom/controlls/revers_L")) -- рычаг реверса лев
defineProperty("revers_R", globalPropertyf("sim/custom/controlls/revers_R")) -- рычаг реверса прав




defineProperty("throttle_lock", globalPropertyf("sim/custom/controlls/throttle_lock")) -- рычаг фиксации РУД
...
defineProperty("rud_1_spd", globalPropertyf("sim/custom/absu/rud_1_spd")) -- скорость изменения положения рычага
defineProperty("rud_2_spd", globalPropertyf("sim/custom/absu/rud_2_spd")) -- скорость изменения положения рычага
defineProperty("rud_3_spd", globalPropertyf("sim/custom/absu/rud_3_spd")) -- скорость изменения положения рычага
